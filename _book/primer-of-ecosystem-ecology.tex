...
\begin{figure}
\includegraphics[width=0.9\linewidth]{/Users/stevenmh/MyDrive/Projects/ecosystems-primer/figs/unnamed-chunk-6-1} \caption{Dynamics of a simple N budget, based on Bormann et al. (1977).}\label{fig:unnamed-chunk-6}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.9\linewidth]{/Users/stevenmh/MyDrive/Projects/ecosystems-primer/figs/unnamed-chunk-7-1} \caption{Dynamics of an N budget, assuming density-dependence in vegetation with a fixed carrying capacity (Bormann et al. 1977).}\label{fig:unnamed-chunk-7}
\end{figure}
