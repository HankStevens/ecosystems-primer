...
To do all this, the following text relies heavily on selected secondary sources especially @soetaert2009 (especially in this chapter and chapter \@ref(Model-Sensitivity)) and @bolker2008rr. I also cite selected a few primary sources where appropriate.
