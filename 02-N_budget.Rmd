...
kbl(df, caption="Annual rate parameters, variables, units and estimates for a simplified model of Bormann et al. (1977). All fluxes ($\\Delta X/ \\Delta y$) are in units of kg ha$^{-1}$ y$^{-1}$. (Note that calculations should not be included in your final table, but are presented here for comparison to your own calculations.)", align = c("l","c","c"), escape=FALSE)
```
